...
ApplicationError.codes = {
    ...
    REQUIRE_DB_MANAGER_ERROR:          'REQUIRE_DB_MANAGER_ERROR',
    REQUIRE_HELPER_MANAGER_ERROR:      'REQUIRE_HELPER_MANAGER_ERROR',
    REQUIRE_LOGGER_MANAGER_ERROR:      'REQUIRE_LOGGER_MANAGER_ERROR',
